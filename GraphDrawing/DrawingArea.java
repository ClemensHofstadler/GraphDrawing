...
public class DrawingArea extends JPanel{
	...
	private Graph G;
	/**
	 * Boolean value determining whether the current layout
	 * of the graph requires linear edges or semicircular edges.
	 */
...
//=======================================================================		
	...
	/**
	 * Given an x-coordinate of the current displayed (possibly zoomed in) 
	 * graph section, this method returns the x-coordinate w.r.t. the whole graph.
	 * Note that the x-coordinate has to be given scaled down to [0,1].
	 * 
	...
	/**
	 * Given a y-coordinate of the current displayed (possibly zoomed in) 
	 * graph section, this method returns the y-coordinate w.r.t. the whole graph.
	 * Note that the y-coordinate has to be given scaled down to [0,1].
	 * 
	...
	/**
	 * This method handles the zooming. The double value d determines
	 * whether the user wants to zoom in or out (d > 0 => zoom in;
	 * d < 0 => zoom out). During this zooming process the point 
	 * (x0,y0) will be fixed. 
	 * 
...
//=======================================================================		
	...
	/**
	 * Overriden paint method. Paints the currently saved graph G on the 
	 * graphics object g using the current zoom which fixes the currently saved
	 * point (x,y). If linearEdges is set to true, the graph will be drawn having
	 * linear edges. Otherwise edges are drawn as semicircles.
	 * 
